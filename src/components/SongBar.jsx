    ...
    <div className={`w-full flex flex-row items-center hover:bg-[#4c426e] ${activeSong?.title === song?.title ? 'bg-[#4c426e]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
      ...
      <div className="flex-1 flex flex-row justify-between items-center">
        {/* <img className="w-20 h-20 rounded-lg"
          ...
          src={song.coverart ? `http://localhost:4000/api/${song.coverart}` : `http://localhost:4000/api/${song.album[i].image}`}
        />
        ...
        <div className="relative group">
          ...
          <img
            ...
            src={song.coverart ? `http://localhost:4000/api/${song.coverart}` : `http://localhost:4000/api/${song.album[0].image}`}
            alt={song?.title}
          />
        </div>
          ...
          <BsThreeDotsVertical className='hover:pointer text-white text-lg '  onClick={toggleDropdown} />
              ...
              {showDropdown && (
                <div
                  ...
                  <div className='flex px-2 py-2 text-white hover:bg-gray-600 rounded' onClick={toggleAddPlaylist}>
                ...
                >
                  ...
                  <div>
                    {updatedUser?.playlists?.map((playlist) => (
                      <span className="flex px-2 py-2 text-white hover:bg-gray-600 rounded"
